    ...
    synchronized public void logincheck(){
        try {
            ...
            if(code.equals("0")){
                ...
                mCache.put("image", image, 2 * ACache.TIME_DAY);
                mCache.put("mobile", mobile, 2 * ACache.TIME_DAY);
                mCache.put("appUserId", appUserId, 2 * ACache.TIME_DAY);
                mCache.put("id", id, 2 * ACache.TIME_DAY);
                ...
                for (int i = 0; i < data1.size(); i++) {
                    User user = data1.get(i);
                    if (mobile.equals(user.getMobile()) && appUserId.equals(user.getAppUserId())) {
